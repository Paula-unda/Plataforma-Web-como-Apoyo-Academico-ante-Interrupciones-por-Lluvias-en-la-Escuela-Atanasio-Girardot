...
<head>
    ...
    <title>Panel de Docente - SIEDUCRES</title>
...
<body>
    ...
    <div class="banner-content">
        <h1 class="banner-title">¡Bienvenido, <?php echo htmlspecialchars($_SESSION['usuario_nombre'] ?? 'Docente'); ?>!</h1>
        <p class="banner-subtitle">Panel de control para gestión de contenidos y actividades</p>
    </div>

    <!-- Tarjetas -->
    <main class="main-content">
        <div class="card-grid">
            <!-- Tarjeta 1: GESTIÓN DE CONTENIDOS -->
            <a href="gestion_contenidos.php" class="card card-1">
                <div class="card-icon">
                    <img src="../../../assets/contenidos.svg" alt="Contenidos">
                </div>
                <h2 class="card-title">Gestión de Contenidos</h2>
                
            </a>

            <!-- Tarjeta 2: GESTIÓN DE ACTIVIDADES -->
            <a href="gestion_actividades.php" class="card card-2">
                <div class="card-icon">
                    <img src="../../../assets/Actividades.svg" alt="Actividades">
                </div>
                <h2 class="card-title">Gestión de Actividades</h2>
                
            </a>

            <!-- Tarjeta 3: CALIFICACIONES -->
            <a href="calificaciones.php" class="card card-3">
                <div class="card-icon">
                    <img src="../../../assets/Calificaciones.svg" alt="Calificaciones">
                </div>
            ...
            <!-- Tarjeta 4: FORO -->
            <a href="../comun/foro.php" class="card card-4">
                <div class="card-icon">
                    <img src="../../../assets/foro.svg" alt="Foro">
                </div>
