...
<body>
    ...
    <div class="banner-content">
        <h1 class="banner-title">¡Bienvenido, <?php echo htmlspecialchars($_SESSION['usuario_nombre'] ?? 'Estudiante'); ?>!</h1>
    ...
    <main class="main-content">
        <div class="card-grid">
            <a href="contenidos.php" class="card card-1">
                <div class="card-icon">
            ...
            <!-- Tarjeta 2: ACTIVIDADES (CORREGIDA) -->
            <a href="actividades.php" class="card card-2">
                <div class="card-icon">
